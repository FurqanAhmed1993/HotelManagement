    ...
    public partial class PagingAndSorting : System.Web.UI.UserControl
    {
        ...
        private void setPaginationLinks()
        {
            ...
            if (totalPages < 2)
            {
                ...
                imgNext.ImageUrl = "~/Assets/img/next_btn_ov.jpg";
                imgPrevious.ImageUrl = "~/Assets/img/previous_btn_ov.jpg";
            }
            else
            {
                ...
                if (totalPages == currentPage)
                {
                    ...
                    imgPrevious.ImageUrl = "~/Assets/img/previous_btn.jpg";
                }
                else if (currentPage == 1)
                {
                    ...
                    imgNext.ImageUrl = "~/Assets/img/next_btn.jpg";
                }
                else
                {
                    imgPrevious.Enabled = true;
