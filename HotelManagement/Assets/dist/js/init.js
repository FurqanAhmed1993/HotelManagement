...
var admintres = function(){
	...
	/*Slimscroll*/
	$('.nicescroll-bar').slimscroll({ height: '100%', color: '#ebedf5', disableFadeOut: true, borderRadius: 0, size: '10px', alwaysVisible: false });
	$('.message-nicescroll-bar').slimscroll({height:'229px',size: '10px',color: '#ebedf5',disableFadeOut : true,borderRadius:0});
	$('.message-box-nicescroll-bar').slimscroll({height:'350px',size: '10px',color: '#ebedf5',disableFadeOut : true,borderRadius:0});
	$('.product-nicescroll-bar').slimscroll({height:'346px',size: '10px',color: '#ebedf5',disableFadeOut : true,borderRadius:0});
	$('.app-nicescroll-bar').slimscroll({height:'162px',size: '10px',color: '#ebedf5',disableFadeOut : true,borderRadius:0});
	$('.todo-box-nicescroll-bar').slimscroll({height:'365px',size: '10px',color: '#ebedf5',disableFadeOut : true,borderRadius:0});
	$('.users-nicescroll-bar').slimscroll({height:'370px',size: '10px',color: '#ebedf5',disableFadeOut : true,borderRadius:0});
	$('.users-chat-nicescroll-bar').slimscroll({height:'257px',size: '10px',color: '#ebedf5',disableFadeOut : true,borderRadius:0});
	$('.chatapp-nicescroll-bar').slimscroll({height:'543px',size: '10px',color: '#ebedf5',disableFadeOut : true,borderRadius:0});
	$('.chatapp-chat-nicescroll-bar').slimscroll({height:'483px',size: '10px',color: '#ebedf5',disableFadeOut : true,borderRadius:0});
...
$( '.uploadfile-dragndrop .inputfile' ).each( function()
	{
		var $input	 = $( this ),
